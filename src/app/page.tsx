...
import { VideoBreak } from "@/components/landing/video-break";
...
export default function Home() {
  return (
    <>
      ...
      <HeroGeometric videoSrc="/videos/hero-bg.mp4" />

      {/* Workspace editorial — laptop + café + notebook */}
      <VideoBreak
        src="/videos/photo-work.mp4"
        poster="/images/sections/photo-work.png"
        height="45vh"
        mobileHeight="30vh"
      />
      ...
      <VideoBreak
        src="/videos/photo-meeting.mp4"
        poster="/images/sections/photo-meeting.png"
        height="45vh"
        mobileHeight="28vh"
      />
      ...
      <VideoBreak
        src="/videos/photo-architecture.mp4"
        poster="/images/sections/photo-architecture.png"
        height="38vh"
        mobileHeight="25vh"
      />
